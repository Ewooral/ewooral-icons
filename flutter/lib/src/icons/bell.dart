...
const String _svg = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="ew-icon" data-motion="swing">
  <g class="ew-chrome">
  ...
  <g class="ew-glyph ew-body" transform="translate(12 12.5) scale(0.55) translate(-12 -12)">
    <path fill="currentColor" fill-opacity="0.16" d="M6 17V11a6 6 0 0 1 12 0v6Z"/>
    <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
      <path stroke-width="2.2" d="M6 17V11a6 6 0 0 1 12 0v6"/>
      <path stroke-width="2.2" d="M4.5 17h15"/>
      <path stroke-width="2.2" d="M11.4 4.5a0.6 0.6 0 1 1 1.2 0v1.5"/>
      <path stroke-width="2.2" d="M10.4 18.8a1.8 1.8 0 0 0 3.2 0"/>
    </g>
  </g>
</svg>
''';

class EwBell extends StatelessWidget {
  const EwBell({
    super.key,
    this.size = 24,
    this.color,
