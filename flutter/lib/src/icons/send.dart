...
const String _svg = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="ew-icon" data-motion="slide-r">
  <g class="ew-chrome">
  ...
  <g class="ew-glyph" transform="translate(12 12.5) scale(0.5) translate(-12 -12)">
    <g class="ew-body" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
        <path d="m4.2 12 16.6-7.2-3.4 16.4-5.8-5.6-4.6-1.6 8-7.6"/>
      </g>
  </g>
</svg>
''';

class EwSend extends StatelessWidget {
  const EwSend({
    super.key,
    this.size = 24,
    this.color,
    ...
    this.plain = false,
    this.noPetal = false,
    this.motion = EwMotion.slideRight,
    this.speed,
    this.delay,
