...
const String _svg = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="ew-icon">
  <g class="ew-chrome">
  ...
  <g class="ew-glyph" transform="translate(12 13) scale(0.55) translate(-12 -12)">
    <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
      <g stroke-width="2.2">
        <circle cx="6.4" cy="16.6" r="2.8"/>
        <circle cx="17.6" cy="16.6" r="2.8"/>
        <path class="ew-blade-a" d="M8.6 14.4 18.5 2.5" style="transform-origin:8.6px 14.4px"/>
        <path class="ew-blade-b" d="M15.4 14.4 5.5 2.5" style="transform-origin:15.4px 14.4px"/>
      </g>
      <path stroke-width="1" d="M16.4 19.1c1 0.8 2.1 0.8 2.9 0.2"/>
    </g>
  </g>
</svg>
''';

class EwScissors extends StatelessWidget {
  const EwScissors({
    super.key,
    this.size = 24,
    this.color,
