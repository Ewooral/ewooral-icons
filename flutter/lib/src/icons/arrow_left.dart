...
const String _svg = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="ew-icon" data-motion="slide-l">
  <g class="ew-chrome">
  ...
  <g class="ew-glyph" transform="translate(12 12.5) scale(0.5) translate(-12 -12)">
    <g class="ew-body" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        <path d="M19.5 12H5.1"/>
        <path d="m10.6 6.5-5.5 5.5 5.5 5.5"/>
      </g>
  </g>
</svg>
''';

class EwArrowLeft extends StatelessWidget {
  const EwArrowLeft({
    super.key,
    this.size = 24,
    this.color,
    ...
    this.plain = false,
    this.noPetal = false,
    this.motion = EwMotion.slideLeft,
    this.speed,
    this.delay,
