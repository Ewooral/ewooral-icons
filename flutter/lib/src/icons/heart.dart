...
const String _svg = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="ew-icon" data-motion="pop">
  ...
  <g class="ew-glyph" transform="translate(12 12.5) scale(0.5) translate(-12 -12)">
    <path fill="currentColor" fill-opacity="0.18"
          d="M12 20.4 4.6 13.2a4.3 4.3 0 1 1 6.1-6.1L12 8.4l1.3-1.3a4.3 4.3 0 1 1 6.1 6.1L12 20.4Z"/>
...
class EwHeart extends StatelessWidget {
  const EwHeart({
    super.key,
    this.size = 24,
    this.color,
