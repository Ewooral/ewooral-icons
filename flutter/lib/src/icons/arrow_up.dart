...
const String _svg = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="ew-icon" data-motion="slide-u">
  <g class="ew-chrome">
  ...
  <g class="ew-glyph" transform="translate(12 12.5) scale(0.5) translate(-12 -12)">
    <g class="ew-body" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        <path d="M12 19.5V5.1"/>
        <path d="m6.5 10.6 5.5-5.5 5.5 5.5"/>
      </g>
  </g>
</svg>
''';

class EwArrowUp extends StatelessWidget {
  const EwArrowUp({
    super.key,
    this.size = 24,
    this.color,
