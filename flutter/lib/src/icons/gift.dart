...
const String _svg = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="ew-icon" data-motion="pop">
  ...
  <g class="ew-glyph" transform="translate(12 12.5) scale(0.5) translate(-12 -12)">
    <g fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
        ...
        <path d="M5 12.5v8a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-8"/>
        <path d="M12 8.5v13"/>
        <path d="M8.5 8.5a2.4 2.4 0 0 1 0-4.8c2 0 3.5 2 3.5 4.8"/>
        <path d="M15.5 8.5a2.4 2.4 0 0 0 0-4.8c-2 0-3.5 2-3.5 4.8"/>
      </g>
  </g>
</svg>
''';

class EwGift extends StatelessWidget {
  const EwGift({
    super.key,
    this.size = 24,
    this.color,
