...
const String _svg = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="ew-icon" data-motion="tilt">
  ...
  <g class="ew-glyph" transform="translate(12 12.5) scale(0.5) translate(-12 -12)">
    <g class="ew-body" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
        <path d="M11.4 3.5h7.6a2 2 0 0 1 2 2v7.6a1.6 1.6 0 0 1-0.5 1.1l-8 8a1.6 1.6 0 0 1-2.2 0L3.6 14.7a1.6 1.6 0 0 1 0-2.2l8-8a1.6 1.6 0 0 1 1.1-0.5"/>
      </g>
  </g>
</svg>
''';

class EwTag extends StatelessWidget {
  const EwTag({
    super.key,
    this.size = 24,
    this.color,
