...
const String _svg = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="ew-icon" data-motion="spin">
  <g class="ew-chrome">
  ...
  <g class="ew-glyph" transform="translate(12 12.5) scale(0.5) translate(-12 -12)">
    <g fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
        <path d="M19.5 9.5A8 8 0 0 0 5.4 6.5"/>
        <path d="M4.5 14.5A8 8 0 0 0 18.6 17.5"/>
        <path d="M19.5 4.2v5.3h-5.3"/>
        <path d="M4.5 19.8v-5.3h5.3"/>
      </g>
  </g>
</svg>
''';

class EwRefresh extends StatelessWidget {
  const EwRefresh({
    super.key,
    this.size = 24,
    this.color,
