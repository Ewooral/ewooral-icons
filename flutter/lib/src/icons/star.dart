...
const String _svg = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="ew-icon" data-motion="pop">
  ...
  <g class="ew-glyph" transform="translate(12 12.4) scale(0.5) translate(-12 -12)">
    <path fill="currentColor" fill-opacity="0.18" stroke="currentColor"
          stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"
          d="m12 3.6 2.7 5.5 6 0.9-4.4 4.3 1.1 6L12 17.5l-5.4 2.8 1.1-6L3.3 10l6-0.9L12 3.6Z"/>
  </g>
</svg>
''';

class EwStar extends StatelessWidget {
  const EwStar({
    super.key,
    this.size = 24,
    this.color,
