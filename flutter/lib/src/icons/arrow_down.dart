...
const String _svg = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="ew-icon" data-motion="slide-d">
  <g class="ew-chrome">
  ...
  <g class="ew-glyph" transform="translate(12 12.5) scale(0.5) translate(-12 -12)">
    <g class="ew-body" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        <path d="M12 4.5v14.4"/>
        <path d="m6.5 13.4 5.5 5.5 5.5-5.5"/>
      </g>
  </g>
</svg>
''';

class EwArrowDown extends StatelessWidget {
  const EwArrowDown({
    super.key,
    this.size = 24,
    this.color,
    ...
    this.plain = false,
    this.noPetal = false,
    this.motion = EwMotion.slideDown,
    this.speed,
    this.delay,
