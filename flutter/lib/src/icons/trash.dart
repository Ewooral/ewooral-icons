...
const String _svg = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="ew-icon" data-motion="shake">
  ...
  <g class="ew-glyph" transform="translate(12 12.5) scale(0.5) translate(-12 -12)">
    <g class="ew-body" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
        <path d="M4.5 6.8h15"/>
        <path d="M9.5 6.8V4.8a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v2"/>
        <path d="M6.8 6.8h10.4l-.9 12.4a1.2 1.2 0 0 1-1.2 1.1H8.9a1.2 1.2 0 0 1-1.2-1.1L6.8 6.8Z"/>
...
class EwTrash extends StatelessWidget {
  const EwTrash({
    super.key,
    this.size = 24,
    this.color,
